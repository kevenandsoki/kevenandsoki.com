    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="portfolio examples of what i do best."
        />
      </Head>
      ...
      <Columns style={{ alignItems: "center" }}>
        <TextBox big>
          ...
          <p>
            my commissions are <b>currently closed</b>, but i'm currently{" "}
            <b>accepting requests</b> for <b>work on games</b>!
          </p>
          <p>
            my pricing is <b>$25/minute</b> of music.
          </p>
          <p>
            <a href="https://vgen.co/kevenandsoki">
              for individual commissions, send your requests through VGen!
            </a>
          </p>
          <p>
            if you're interested in hiring me as a composer for a game or
            project, please <b>contact me personally</b> to discuss details:
          </p>
          <p>
            <b>discord</b>: kevenandsoki <br />
            <b>email:</b>{" "}
            <a href="mailto:ali@kevenandsoki.com">ali@kevenandsoki.com</a>
          </p>
        </TextBox>
        <TextBox big subtle>
      ...
      <TextBox big>
        <p>
          below are some more works of mine from over the years, both originals
          and covers.
        </p>
      </TextBox>
      ...
      <div className={styles.musicList}>
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=RZaXk477Hbc">
              Sinister Sundown - Kingdom Hearts II (Faithful Cover)
            </a>
          }
        ...
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=aOj4jtZp8rQ">
              M.Z.M.B.C - FΛDE (Fusion Cover)
            </a>
          }
        ...
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=KjoB68bgrMc">
              To Your Roots (2000s JRPG-inspired original)
            </a>
          }
        ...
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=nAGMtYB0B9k">
              Wily Stage 1/2 - Mega Man 2 (FM Arrange)
            </a>
          }
        ...
        <MusicListing
          label={
            <>
              makeikusa (for{" "}
              <a href="https://twitter.com/Shimada_Swears">@Shimada_Swears</a>)
            </>
          }
        ...
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=FLJYgQvvJ1E">
              Windmill Isle (Day) - Sonic Unleashed (Arrange)
            </a>
          }
        ...
        <MusicListing
          label={
            <a href="https://www.youtube.com/watch?v=ZB-9H-o7QQo">
              lost humanity
            </a>
          }
